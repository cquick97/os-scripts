...
timezone="US/Eastern"    	# Eastern, US
...
if [[ $? == 0 ]]; then
  ...
  echo -e "\n$GREEN[+]$RESET Setting a static IP address (192.168.56.175/24) on eth1"
  ifconfig eth1 192.168.56.175/24
...
#echo -e "\n$GREEN[+]$RESET Updating hostname (to 'shadow')"
hostname="shadow"
#--- Change it now
hostname "$hostname"
